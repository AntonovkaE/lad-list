...
const commonArray = ['New York', 'Paris', 'Ufa', 'Asha', 'Нижний Новгород', 'Mexico', 'Prague', 'Austin', 'Amsterdam', 'Berlin', 'Kiev', 'kazan', 'Газиабад', 'Экатепек', 'Belawan', 'Ситамархи'];

export {windImg, stormImg, sunImg, snowImg, rainImg, fogImg, cloudsImg, commonArray}
